...
def get_kmer_counts_expeted(kmer_list, kmer_counts, kmer_expected):
    kmers = []
    for kmer in kmer_list:
...
def compute_stats(kmer_list, counts, len_seq, max_e):
    """
    ...
    for kmer in kmer_list:
        ...
        sigma = math.sqrt(expected * (1 - expected / (len_seq - k + 1)))
